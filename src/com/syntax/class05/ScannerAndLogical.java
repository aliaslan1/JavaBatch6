...
public class ScannerAndLogical {
	...
	public static void main(String[] args) {
		 ...
		 * of sales we need to calculate his commission if sales is between 1 - 100 -->
		 * commission should be 10% if sales is between 100 and 200 --> commission
		 * should be 20% if sales is between 200 and 500 --> commission should be 30% if
